...
const Dashboard: React.FC = () => {
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] text-foreground space-y-4">
                <AlertCircle className="h-12 w-12 text-rose-500" />
                <h2 className="text-xl font-bold">{t('common.error')}</h2>
                <p className="text-muted-foreground">{error}</p>
                <Button onClick={() => window.location.reload()} variant="outline" className="border-border hover:bg-primary/10 hover:text-primary">
                    {t('common.retry')}
                </Button>
            </div>
        );
    ...
    return (
        <div className="space-y-4 pb-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-foreground">{t('dashboard.welcome_user', { name: user?.firstName || 'User' })}</h1>
                    <p className="text-muted-foreground text-sm mt-0.5">
                        {t('dashboard.orders_today', { count: stats?.ordersToday || 0 })}
                    </p>
                </div>
                <div className="flex items-center gap-2">
                    <Button variant="outline" className="h-8 border-border text-gray-500 hover:bg-primary/10 hover:text-primary text-xs">
                    ...
                    <div className="flex items-center gap-2 text-orange-700 text-sm">
                        ...
                        <p>
                            ...
                            <span
                                ...
                                className="ml-1 underline cursor-pointer hover:text-primary"
                            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {/* Sales Return Today */}
                <Card className="bg-gray-900 border-none text-white relative overflow-hidden">
                    <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                            <div className="min-w-0">
                                <h3 className="text-xl font-bold text-white truncate">{formatCurrency(stats?.salesReturnsToday || 0)}</h3>
                                <p className="text-gray-400 text-xs font-medium mt-0.5 truncate">{t('dashboard.sales_return_today')}</p>
                            </div>
                        ...
                        <div className="mt-4 flex items-center justify-between text-xs">
                            ...
                            <span
                                ...
                                className="text-gray-500 text-[10px] underline cursor-pointer hover:text-white"
                            >
                                {t('dashboard.vs_last_month')}
                            </span>
                        </div>
                ...
                <Card className="bg-primary border-none text-white relative overflow-hidden">
                    <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                            <div className="min-w-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="border border-border shadow-sm">
                    <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                            <div className="min-w-0">
                                <h3 className="text-xl font-bold text-foreground truncate">{formatCurrency(stats?.totalProfit || 0)}</h3>
                                <p className="text-muted-foreground text-xs font-medium mt-0.5 truncate">{t('dashboard.profit')}</p>
                            </div>
                        ...
                        <div className="mt-4 flex items-center justify-between text-xs">
                            ...
                            <Button 
                                variant="link" 
                                className="text-foreground h-auto p-0 underline hover:text-sky-500"
                ...
                <Card className="border border-border shadow-sm">
                    <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                            <div className="min-w-0">
                                <h3 className="text-xl font-bold text-foreground truncate">{formatCurrency(0)}</h3>
                                <p className="text-muted-foreground text-xs font-medium mt-0.5 truncate">{t('dashboard.invoice_due')}</p>
                            </div>
                        ...
                        <div className="mt-4 flex items-center justify-between text-xs">
                            ...
                            <Button 
                                variant="link" 
                                className="text-foreground h-auto p-0 underline hover:text-emerald-500"
                                onClick={() => navigate('/sales/history')}
                            >
                                {t('dashboard.view_all')}
                            </Button>
                ...
                <Card className="border border-border shadow-sm">
                    <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                            <div className="min-w-0">
                                <h3 className="text-xl font-bold text-foreground truncate">{formatCurrency(0)}</h3>
                                <p className="text-muted-foreground text-xs font-medium mt-0.5 truncate">{t('dashboard.total_expenses')}</p>
                            </div>
                        ...
                        <div className="mt-4 flex items-center justify-between text-xs">
                            ...
                            <Button 
                                variant="link" 
                                className="text-foreground h-auto p-0 underline hover:text-orange-500"
                                onClick={() => navigate('/reports')}
                            >
                                {t('dashboard.view_all')}
                            </Button>
                ...
                <Card className="border border-border shadow-sm">
                    <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                            <div className="min-w-0">
                                <h3 className="text-xl font-bold text-foreground truncate">{formatCurrency(0)}</h3>
                                <p className="text-muted-foreground text-xs font-medium mt-0.5 truncate">{t('dashboard.total_payment_returns')}</p>
                            </div>
                        ...
                        <div className="mt-4 flex items-center justify-between text-xs">
                            ...
                            <Button 
                                variant="link" 
                                className="text-foreground h-auto p-0 underline hover:text-indigo-500"
                                onClick={() => navigate('/sales/returns')}
                            >
                                {t('dashboard.view_all')}
                            </Button>
