                        ...
                        <Table>
                            <TableHeader className="bg-slate-800/50">
                                <TableRow className="border-white/10 hover:bg-transparent">
                                    <TableHead className="text-slate-300">Acha #</TableHead>
                                    <TableHead className="text-slate-300">Dat</TableHead>
                                    <TableHead className="text-slate-300">Founisè</TableHead>
                                    <TableHead className="text-slate-300">Point of Sale</TableHead>
